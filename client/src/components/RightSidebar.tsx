...
export default function RightSidebar() {
    ...
    return (
        <>
            ...
            {/* Панель */}
            {open && (
                <div className="fixed right-0 top-0 z-20 h-full w-[240px] bg-[var(--color-bg-primary)] border-l border-[var(--color-border-default)] overflow-y-auto p-3 pt-14 shadow-2xl">
