...
export default function ChatTabs({ privateChatWith, openPrivateTabs, onSelectPublic, onSelectPrivate, onCloseTab }: ChatTabsProps) {
  ...
  return (
    <div style={{ display: 'flex', background: '#1e1e30', borderBottom: '1px solid #444', overflowX: 'auto' }}>
      <div onClick={onSelectPublic} style={{
        ...
        background: privateChatWith === null ? '#333' : 'transparent',
        borderRight: '1px solid #444', whiteSpace: 'nowrap',
        fontWeight: privateChatWith === null ? 'bold' : 'normal', color: '#eee',
      }}>Общий чат</div>
