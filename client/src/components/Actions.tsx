...
const cards = [
    ...
    { icon: 'game-icons:treasure-map', title: 'Сундук', subtitle: 'Хранение золота', cost: 0, path: '/bank', buttonText: 'Перейти', bgClass: 'url(/action_craft.webp)', variant: 'danger' as const },
];
