...
const tutorialSteps: TutorialStep[] = [
  ...
  // --- 8. Усиления — обзор (разворачиваем блок) ---
  {
    ...
    title: 'Усиления',
    description: 'Временные и постоянные баффы. Комнаты ускоряют регенерацию HP, напитки дают боевые бонусы, премиум сокращает кулдауны. Коллекции — постоянный бонус к статам.',
    tooltipPosition: 'right',
  ...
  // --- 12. Коллекция ---
  {
    ...
    title: 'Коллекция',
    description: 'Собирайте предметы экипировки — каждый сет даёт постоянный бонус ко всем характеристикам (до 5%). Прогресс виден в процентах.',
    tooltipPosition: 'right',
  },
  // --- 13. Инвентарь ---
  {
