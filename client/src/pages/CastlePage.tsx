...
const FACTION_INFO: Record<string, { icon: string; color: string; bgColor: string; name: string; bonus: string }> = {
    ...
    guard: { icon: 'game-icons:shield', color: 'text-yellow-300', bgColor: 'bg-yellow-900/20 border-yellow-700/30', name: 'Стражник', bonus: '+10% против Бандитов и в PvE, жалование увеличено до 100%' },
};
