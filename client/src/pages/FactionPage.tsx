...
const FACTIONS: Record<string, { icon: string; color: string; bgColor: string; name: string; desc: string; bonus: string }> = {
    ...
    crafter: { icon: 'game-icons:anvil', color: 'text-blue-300', bgColor: 'border-[#28285a]', name: 'Ремесленники', desc: 'Мастера и торговцы. Лучшие в крафте и заработке.', bonus: '+10% шанс крафта/улучшения +1% за 100 успешных. +100% награда за работы.' },
    guard: { icon: 'game-icons:shield', color: 'text-yellow-300', bgColor: 'border-[#5a5a28]', name: 'Стражники', desc: 'Защитники порядка. Эффективны против бандитов и монстров.', bonus: '+10% против Бандитов и в PvE. Карма: +1 бандит/моб, -1 мирный. +1% жалования за очко.' },
};
