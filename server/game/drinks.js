...
exports.DRINK_BONUSES = void 0;
exports.getDrinkBonuses = getDrinkBonuses;
// Бонусы напитков (ключ → статы)
exports.DRINK_BONUSES = {
...
function getDrinkBonuses(user) {
    const now = Math.floor(Date.now() / 1000);
    if (!user.activeDrink || !user.drinkUntil || user.drinkUntil <= now)
        return empty;
    return exports.DRINK_BONUSES[user.activeDrink] || empty;
}
