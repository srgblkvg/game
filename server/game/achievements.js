...
exports.TRACK_MAP = exports.ACHIEVEMENT_TRACKS = void 0;
exports.getTrackTier = getTrackTier;
exports.getTrackProgress = getTrackProgress;
exports.ACHIEVEMENT_TRACKS = [
    {
        key: 'pvp_wins',
        name: 'PvP побед',
        icon: '⚔',
...
exports.TRACK_MAP = new Map(exports.ACHIEVEMENT_TRACKS.map(t => [t.key, t]));
function getTrackTier(track, progress) {
    let best = null;
...
function getTrackProgress(tier, next) {
