...
router.put('/actions/:id', async async (req, res) => {
    const { section, title, subtitle, icon, bg_image, path, cost, sort_order } = req.body;
...
router.put('/floors/:id', async async (req, res) => {
    const { name, background, sort_order } = req.body;
...
router.delete('/floors/:id', async async (req, res) => {
