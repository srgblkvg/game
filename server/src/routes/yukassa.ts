...
const ITEMS: Record<string, ShopItem> = {
  ...
  curse_x50:     { title: 'Сундук «Проклятый» ×50 (5M + 50 кристаллов)', price: 7999, type: 'curse_pack' },
  curse_x100:    { title: 'Сундук «Проклятый» ×100 (10M + 100 кристаллов)', price: 14999, type: 'curse_pack' },
