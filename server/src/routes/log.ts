...
router.get('/pve-battles', authMiddleware, async (req: any, res) => {
...
router.get('/tournament-history', authMiddleware, async (req: any, res) => {
    const userId = req.userId;
    const limit = parseInt(req.query.limit as string) || 50;
...
router.post('/log/error', async (req: any, res) => {
