...
const ITEMS: Record<string, VkItem> = {
  ...
  curse_x50:     { title: 'Сундук «Проклятый» ×50 (5M + 50 кристаллов)', price: 1149, type: 'curse_pack' },
  curse_x100:    { title: 'Сундук «Проклятый» ×100 (10M + 100 кристаллов)', price: 2149, type: 'curse_pack' },
