...
const FACTIONS = {
    bandit: { name: 'Бандиты', desc: '+10% против Ремесленников. Атаки ±4 уровня. +1% к доходу PvP за 100 побед. Таймер атаки ×2 быстрее.' },
    crafter: { name: 'Ремесленники', desc: '+10% шанс крафта/улучшения +1% за 100 успешных. +100% награда за работы.' },
    guard: { name: 'Стражники', desc: '+10% против Бандитов и в PvE. Карма: +1 за бандита/моба, -1 за мирных. +1% жалования за очко кармы.' },
} as const;
