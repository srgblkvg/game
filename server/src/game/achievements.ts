...
export const ACHIEVEMENT_TRACKS: AchievementTrack[] = [
    {
        ...
        tiers: [
            { tier: 1, name: 'Бронза', icon: '🥉', threshold: 1 },
            { tier: 2, name: 'Серебро', icon: '🥈', threshold: 25 },
            { tier: 3, name: 'Золото', icon: '🥇', threshold: 250 },
            { tier: 4, name: 'Алмаз', icon: '💎', threshold: 2500 },
            { tier: 5, name: 'Легенда', icon: '👑', threshold: 10000 },
        ],
    },
    {
        key: 'pve_wins',
        ...
        tiers: [
            ...
            { tier: 3, name: 'Золото', icon: '🥇', threshold: 500 },
    ...
    },
    {
        ...
        tiers: [
            ...
            { tier: 4, name: 'Алмаз', icon: '💎', threshold: 500 },
    ...
    },
    {
        ...
        tiers: [
            ...
            { tier: 3, name: 'Золото', icon: '🥇', threshold: 100 },
            { tier: 4, name: 'Алмаз', icon: '💎', threshold: 500 },
            { tier: 5, name: 'Легенда', icon: '👑', threshold: 2000 },
        ],
    },
    {
        key: 'income',
        ...
        tiers: [
            { tier: 1, name: 'Бронза', icon: '🥉', threshold: 500 },
            { tier: 2, name: 'Серебро', icon: '🥈', threshold: 5000 },
            { tier: 3, name: 'Золото', icon: '🥇', threshold: 50000 },
            { tier: 4, name: 'Алмаз', icon: '💎', threshold: 500000 },
            { tier: 5, name: 'Легенда', icon: '👑', threshold: 5000000 },
        ],
    },
    {
        key: 'casino',
    ...
    },
    {
        ...
        tiers: [
            ...
            { tier: 5, name: 'Легенда', icon: '👑', threshold: 189 },
        ],
    },
    {
        key: 'auction',
    ...
    },
    {
        ...
        tiers: [
            { tier: 1, name: 'Бронза', icon: '🥉', threshold: 1 },
            { tier: 2, name: 'Серебро', icon: '🥈', threshold: 5 },
            { tier: 3, name: 'Золото', icon: '🥇', threshold: 25 },
            { tier: 4, name: 'Алмаз', icon: '💎', threshold: 100 },
            { tier: 5, name: 'Легенда', icon: '👑', threshold: 250 },
        ],
    },
    {
        key: 'level',
